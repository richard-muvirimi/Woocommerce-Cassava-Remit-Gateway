 ...
 * Provides a Cassava Remit Payment Gateway.
 *
 * @class 		WC_Gateway_Cassava_Remit
...
class WC_Gateway_Cassava_Remit extends WC_Payment_Gateway
{
	...
	public function __construct()
	{
		...
		$this->id = 'cassavaremit';
		$this->icon = apply_filters('woocommerce_cassavaremit_icon', plugins_url('cassavaremit.png', __FILE__));
		$this->has_fields = false;
		$this->method_title = __('Cassava Remit', 'woocommerce');
		$this->method_description = __('Permits payments using Cassava Remit.', 'woocommerce');
		...
		add_action('woocommerce_thankyou_cassavaremit', array($this, 'thankyou_page'));
	...
	public function init_form_fields()
	{
		...
		$this->form_fields = array(
			'enabled' => array('title' => __('Enable/Disable', 'woocommerce'), 'type' => 'checkbox', 'label' => __('Enable Cassava Remit?', 'woocommerce'), 'default' => 'yes'),
			'order_stat' => array(
			...
			'title' => array('title' => __('Title', 'woocommerce'), 'type' => 'text', 'description' => __('This controls the title which the user sees during checkout.', 'woocommerce'), 'default' => __('Cassava Remit', 'woocommerce'), 'desc_tip' => false),
	...
	public function process_payment($order_id)
	{
		...
		$order->update_status($this->order_stat, __('Awaiting Cassava Remit payment.', 'woocommerce'));
